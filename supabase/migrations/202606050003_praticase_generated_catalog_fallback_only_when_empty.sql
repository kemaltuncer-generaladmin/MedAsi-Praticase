-- Fallback test options should only fill completely empty groups. Generated
-- cases already carry case-specific options; adding generic Hemogram/USG/BT
-- rows to non-empty groups makes the exam catalog noisy.
...
values (
  '202606050003_praticase_generated_catalog_fallback_only_when_empty',
  '202606050003_praticase_generated_catalog_fallback_only_when_empty.sql'
)
